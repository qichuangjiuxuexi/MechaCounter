...
namespace WordGame.Utils
{
    ...
    public class ScreenInfo
    {
        ...
        /// 设计分辨率宽
        /// </summary>
        public const float DESIGN_SCREEN_WIDTH = 750;
        ...
        /// 设计分辨率高
        /// </summary>
        public const float DESIGN_SCREEN_HEIGHT = 1334;
    ...
    public class SafeAdapt : MonoBehaviour
    {
        ...
        private void SetAdapt(bool needBottomSafe = false)
        {
            if (rectTransform == null)
            {
                ...
                if (rectTransform != null)
                {
                    rectTransform.offsetMax = new Vector2(rectTransform.offsetMax.x, -1 * GetSafeAreaSize().y);
                }
            }

            if (needBottomSafe)
            {
                rectTransform.offsetMin = new Vector2(0, GetSafeAreaHeightFromBottom());
            }
